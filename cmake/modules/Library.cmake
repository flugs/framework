...
function(QC_ADD_LIBRARY)
    ...
    set_target_properties(${ARG_TARGET} PROPERTIES CXX_STANDARD 14)
...
function(QC_INSTALL_LIBRARY)
    ...
    install(TARGETS ${ARG_TARGET} EXPORT "${ARG_NS}Targets" ${INSTALL_TARGETS_DEFAULT_ARGS})
    install(EXPORT "${ARG_NS}Targets" DESTINATION "${CMAKE_CONFIG_INSTALL_DIR}")
